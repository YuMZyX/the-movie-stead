describe('Users/User', function() {
  ...
  describe('When logged in', function() {
    ...
    it('moderator can disable user', function() {
      ...
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Edit"]').click({ force: true })
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="disabled"]').find('input').click({ force: true })
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Save"]').click({ force: true })
      cy.wait(500)
  ...
  describe('When logged in', function() {
    ...
    it('admin can disable moderator', function() {
      cy.get('#users').click({ force: true })
      cy.get('.MuiDataGrid-main').find('[title="moderator@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Edit"]').click({ force: true })
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="moderator@gmail.com"]').parent().parent()
        .find('[data-field="disabled"]').find('input').click({ force: true })
    ...
    it('admin can delete user', function() {
      cy.get('#users').click({ force: true })
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Delete"]').click({ force: true })
      cy.wait(500)
    ...
    it('admin can promote user to moderator', function() {
      ...
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="role"]').click().get('ul > li[data-value="moderator"]').click({ force: true })
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="regular@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Save"]').click({ force: true })
      cy.wait(500)
    ...
    it('admin can demote moderator to user', function() {
      ...
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="moderator@gmail.com"]').parent().parent()
        .find('[data-field="role"]').click().get('ul > li[data-value="user"]').click({ force: true })
      cy.wait(500)
      cy.get('.MuiDataGrid-main').find('[title="moderator@gmail.com"]').parent().parent()
        .find('[data-field="actions"]').find('[aria-label="Save"]').click({ force: true })
      cy.wait(500)
